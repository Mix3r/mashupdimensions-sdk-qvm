...
void CG_ScorePlum( int client, vec3_t org, int score, int dmgfl) {
	...
	if (client != cg.predictedPlayerState.clientNum) {
        ...
        if (dmgfl > 0) {
                ...
                if (dmgfl > 100) {
                        dmgfl -= 100;
                        trap_S_StartSound(NULL, client, CHAN_AUTO, cgs.media.MeleeHitSound);
                }
                switch( dmgfl ) {
                        case 1:trap_S_StartLocalSound( cgs.media.hitSound, CHAN_LOCAL_SOUND ); break;
                        case 2:trap_S_StartLocalSound( cgs.media.hitSoundLowArmor, CHAN_LOCAL_SOUND ); break;
                        case 3:trap_S_StartLocalSound( cgs.media.hitSoundHighArmor, CHAN_LOCAL_SOUND ); break;
                        //case 4:trap_S_StartLocalSound( cgs.media.objHitSound1, CHAN_LOCAL_SOUND ); break;
                        //case 5:trap_S_StartLocalSound( cgs.media.objHitSound2, CHAN_LOCAL_SOUND ); break;
                        //case 6:trap_S_StartLocalSound( cgs.media.objHitSound3, CHAN_LOCAL_SOUND ); break;
                        case 7:trap_S_StartLocalSound( cgs.media.obeliskHitSound1, CHAN_LOCAL_SOUND ); break;
                        case 8:trap_S_StartLocalSound( cgs.media.obeliskHitSound2, CHAN_LOCAL_SOUND ); break;
                        case 9:trap_S_StartLocalSound( cgs.media.obeliskHitSound3, CHAN_LOCAL_SOUND ); break;
                }
...
void CG_Bleed( vec3_t origin, int entityNum ) {
        trap_S_StartSound( origin, ENTITYNUM_WORLD, CHAN_AUTO, cgs.media.sfx_chghitflesh );
//	localEntity_t	*ex;
