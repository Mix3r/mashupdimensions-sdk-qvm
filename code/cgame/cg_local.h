...
#define	DEFAULT_MODEL			"angelyss"

#define	DEFAULT_TEAM_MODEL		"angelyss"
#define	DEFAULT_TEAM_HEAD		"angelyss"
...
typedef struct {
	...
	vec3_t			pGunPoint;		// Mix3r_Durachok: point to shoot projectile trail from
...
typedef struct {
	...
	// status bar head. Mix3r_Durachok: headendyaw reserved for weapon sway instead
        // headendpitch reserved for pitching value of weapon position in mods (tweaked for q3 as mod)
        // headyaw used for frag scoring hud effect
        // headstarttime is for red team scoring hud effect
        // headendtime is for blue team scoring hud effect
...
// frag message icon shaders
	...
	sfxHandle_t obeliskHitSound3;
        //sfxHandle_t objHitSound1;
	//sfxHandle_t objHitSound2;
	//sfxHandle_t objHitSound3;
	sfxHandle_t	obeliskRespawnSound;
	sfxHandle_t	winnerSound;
	sfxHandle_t	jumpbSound;
	sfxHandle_t	landbSound;
	...
	sfxHandle_t	noAmmoSound;
        sfxHandle_t	MeleeHitSound;
        sfxHandle_t	MeleeBlocked1;
        sfxHandle_t	MeleeBlocked2;
...
/* /Neon_Knight */
extern sfxHandle_t CG_CacheLocalizedSound(char *snd);
extern qboolean regsnd_flag; // Mix3r_Durachok: flag to register sound. some sounds use qfalse instead of commonly used qtrue
