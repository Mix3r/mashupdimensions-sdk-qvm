...
//unlagged - server options
	...
	//Now for elimination stuff:
        { &g_bot_selfdestruct, "bot_selfdestruct", "0", 0, 0, qtrue },
	...
	{ &g_elimination_machinegun, "elimination_machinegun", "100", CVAR_ARCHIVE, 0, qtrue },
	{ &g_elimination_shotgun, "elimination_shotgun", "50", CVAR_ARCHIVE, 0, qtrue },
	{ &g_elimination_grenade, "elimination_grenade", "32", CVAR_ARCHIVE, 0, qtrue },
	...
	{ &g_elimination_lightning, "elimination_lightning", "200", CVAR_ARCHIVE, 0, qtrue },
	{ &g_elimination_plasmagun, "elimination_plasmagun", "100", CVAR_ARCHIVE, 0, qtrue },
	{ &g_elimination_chain, "elimination_chain", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &g_elimination_mine, "elimination_mine", "3", CVAR_ARCHIVE, 0, qtrue },
	...
	{ &g_elimination_lockspectator, "elimination_lockspectator", "2", 0, qtrue },
...
#else
	{ &g_runes, "g_runes", "1", CVAR_LATCH|CVAR_ARCHIVE, 0, qfalse },
#endif
...
//used for voIP
	...
	{ &g_bot_noChat, "bot_nochat", "1", 0, 0, qtrue}
...
qboolean ScoreIsTied( void )
{
	...
	return level.clients[level.sortedClients[0]].ps.persistant[PERS_SCORE] == level.clients[level.sortedClients[1]].ps.persistant[PERS_SCORE];
}
