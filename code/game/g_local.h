...
// flood protection
	int         floodDemerits;
	int         floodTime;
// Mix3r_Durachok: gauntles block serverside stuff:
        int nMeleeBlockPawn;
        int nMeleeBlockTimestamp;
...
gentity_t *RelaySomebody(int mde, vec3_t orig,int dist,char *msg); // Mix3r_Durachok: relay monsters in sp
...
//elimination:
extern vmCvar_t g_bot_selfdestruct;
