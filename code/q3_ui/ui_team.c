...
void TeamMain_MenuInit( void ) {
	...
	s_teammain.joinred.string           = COM_Localize(277);
	...
	s_teammain.joinblue.string           = COM_Localize(278);
	...
	s_teammain.joingame.string           = COM_Localize(127);
	...
	s_teammain.spectate.string           = COM_Localize(279);
