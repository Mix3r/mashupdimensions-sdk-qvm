...
static void PlayerSettings_DrawName2( void *self ) {
	...
	UI_DrawProportionalString( basex, y, COM_Localize(75), style, color );
...
static void FirstConnect_StatusBar_Name( void* ptr ) {
		UI_DrawString( 320, 440, COM_Localize(76), UI_CENTER|UI_SMALLFONT, colorWhite );
}
...
static void FirstConnect_StatusBar_Rate( void* ptr ) {
		UI_DrawString( 320, 440, COM_Localize(77), UI_CENTER|UI_SMALLFONT, colorWhite );
}
...
static void FirstConnect_StatusBar_Delag( void* ptr ) {
		UI_DrawString( 320, 440, COM_Localize(78), UI_CENTER|UI_SMALLFONT, colorWhite );
}
...
static void FirstConnect_StatusBar_Download( void* ptr ) {
		UI_DrawString( 320, 440, COM_Localize(79), UI_CENTER|UI_SMALLFONT, colorWhite );
}
...
void FirstConnect_MenuInit( void )
{
	...
	s_firstconnect.banner.string		 = COM_Localize(80);
	...
	s_firstconnect.rate.generic.name		= COM_Localize(81);
	...
	s_firstconnect.rate.itemnames			= rate_items;
        s_firstconnect.rate.itemnames[0] = "<= 28.8K";
	s_firstconnect.rate.itemnames[1] = "33.6K";
	s_firstconnect.rate.itemnames[2] = "56K";
	s_firstconnect.rate.itemnames[3] = "ISDN";
	s_firstconnect.rate.itemnames[4] = COM_Localize(151);
	...
	s_firstconnect.delaghitscan.generic.name	   = COM_Localize(82);
	...
	s_firstconnect.allowdownload.generic.name	   = COM_Localize(83);
	...
	s_firstconnect.info.style  		 = UI_CENTER|UI_SMALLFONT;
        s_firstconnect.info.string           = COM_Localize(84);
	...
	s_firstconnect.info2.style  		 = UI_CENTER|UI_SMALLFONT;
        s_firstconnect.info2.string           = COM_Localize(85);
