...
static void InGame_Menu_Draw( void ) {

	//UI_DrawBannerString( 320, 16, "CALL VOTE", UI_CENTER, color_white );
	//UI_DrawNamedPic( 320-233, 240-166, 466, 332, ART_BACKGROUND );
	// standard menu drawing
        if (uis.cursory <= -100) {      // Mix3r weird fix to get rid of ingame menu after calling vote
           uis.cursory = 80;
           UI_PopMenu();
        }
...
void InGame_MenuInit( void ) {
	...
	s_ingame.menu.fullscreen = qfalse;
        s_ingame.menu.draw = InGame_Menu_Draw;
	...
	s_ingame.team.string				= COM_Localize(205);
	...
	s_ingame.addbots.string				= COM_Localize(206);
	...
	s_ingame.removebots.string				= COM_Localize(207);
	...
	s_ingame.teamorders.string				= COM_Localize(208);
	...
	s_ingame.vote.string				= COM_Localize(209);
	...
	s_ingame.setup.string				= COM_Localize(4);
	...
	s_ingame.server.string				= COM_Localize(210);
	...
	s_ingame.restart.string				= COM_Localize(211);
	...
	s_ingame.resume.string					= COM_Localize(212);
	...
	s_ingame.leave.string				= COM_Localize(213);
	...
	s_ingame.quit.string				= COM_Localize(7);
