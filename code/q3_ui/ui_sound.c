...
static const char *quality_items[] = {"","",NULL};
...
static void UI_SoundOptionsMenu_Init( void ) {
	...
	soundOptionsInfo.banner.string				= COM_Localize(129);
	...
	soundOptionsInfo.graphics.string			= COM_Localize(138);
	...
	soundOptionsInfo.display.string				= COM_Localize(139);
	...
	soundOptionsInfo.sound.string				= COM_Localize(140);
	...
	soundOptionsInfo.network.string				= COM_Localize(141);
	...
	soundOptionsInfo.sfxvolume.generic.name		= COM_Localize(142);
	...
	soundOptionsInfo.musicvolume.generic.name		= COM_Localize(143);
	...
	soundOptionsInfo.quality.generic.name		= COM_Localize(144);
	...
	soundOptionsInfo.quality.itemnames			= quality_items;
        soundOptionsInfo.quality.itemnames[0] = COM_Localize(145);
        soundOptionsInfo.quality.itemnames[1] = COM_Localize(147);
/*
	y += BIGCHAR_HEIGHT+2;
