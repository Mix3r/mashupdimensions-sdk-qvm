...
static void UI_AddBotsMenu_FightEvent( void* ptr, int event ) {
	const char	*team;
	int		skill;
        char *teamNamesEN[] = { "Red", "Blue", NULL };
	...
	team = teamNamesEN[addBotsMenuInfo.team.curvalue];
	...
	addBotsMenuInfo.botnames[addBotsMenuInfo.selectedBotNum], skill, team, addBotsMenuInfo.delay) );
        skill = (int)trap_Cvar_VariableValue( "bot_minplayers" ) + 1;
        if (skill > 1) {
	  trap_Cvar_SetValue( "bot_minplayers", skill );
        }
...
static void UI_AddBotsMenu_Draw( void ) {
	UI_DrawBannerString( 320, 16, COM_Localize(206), UI_CENTER, color_white );
...
static void UI_AddBotsMenu_Init( void ) {
	...
	addBotsMenuInfo.skill.generic.name		= COM_Localize(54);
	...
	addBotsMenuInfo.skill.curvalue			= Com_Clamp( 0, 4, (int)trap_Cvar_VariableValue( "g_spSkill" ) - 1 );
        addBotsMenuInfo.skill.itemnames[0] = COM_Localize(24);
	addBotsMenuInfo.skill.itemnames[1] = COM_Localize(25);
	addBotsMenuInfo.skill.itemnames[2] = COM_Localize(26);
	addBotsMenuInfo.skill.itemnames[3] = COM_Localize(27);
	addBotsMenuInfo.skill.itemnames[4] = COM_Localize(28);
	...
	addBotsMenuInfo.team.generic.name		= COM_Localize(280);
	addBotsMenuInfo.team.generic.id			= ID_TEAM;
	if(UI_IsATeamGametype(gametype)) {
		addBotsMenuInfo.team.itemnames		= teamNames2;
                addBotsMenuInfo.team.itemnames[0] =     COM_Localize(68);
                addBotsMenuInfo.team.itemnames[1] =     COM_Localize(67);
	}
	else {
		addBotsMenuInfo.team.itemnames		= teamNames1;
                addBotsMenuInfo.team.itemnames[0]       = COM_Localize(127);
