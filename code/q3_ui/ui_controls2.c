...
{
	{"+scores",     "",      ID_SHOWSCORES,	ANIM_IDLE,		K_TAB,			-1,		-1, -1},
	{"+button2",    "",         ID_USEITEM,		ANIM_IDLE,		K_ENTER,		-1,		-1, -1},
	{"+speed",      "",       ID_SPEED,		ANIM_RUN,		K_SHIFT,		-1,		-1,	-1},
	{"+forward",    "",     ID_FORWARD,		ANIM_WALK,		K_UPARROW,		-1,		-1, -1},
	{"+back",       "",        ID_BACKPEDAL,	ANIM_BACK,		K_DOWNARROW,	-1,		-1, -1},
	{"+moveleft",   "",        ID_MOVELEFT,	ANIM_STEPLEFT,	',',			-1,		-1, -1},
	{"+moveright",  "",       ID_MOVERIGHT,	ANIM_STEPRIGHT,	'.',			-1,		-1, -1},
	{"+moveup",     "",        ID_MOVEUP,		ANIM_JUMP,		K_SPACE,		-1,		-1, -1},
	{"+movedown",   "",    ID_MOVEDOWN,	ANIM_CROUCH,	'c',			-1,		-1, -1},
	{"+left",       "",        ID_LEFT,		ANIM_TURNLEFT,	K_LEFTARROW,	-1,		-1, -1},
	{"+right",      "",       ID_RIGHT,		ANIM_TURNRIGHT,	K_RIGHTARROW,	-1,		-1, -1},
	{"+strafe",     "",  ID_STRAFE,		ANIM_IDLE,		K_ALT,			-1,		-1, -1},
	{"+lookup",     "",          ID_LOOKUP,		ANIM_LOOKUP,	K_PGDN,			-1,		-1, -1},
	{"+lookdown",   "",        ID_LOOKDOWN,	ANIM_LOOKDOWN,	K_DEL,			-1,		-1, -1},
	{"+mlook",      "",       ID_MOUSELOOK,	ANIM_IDLE,		-1,			-1,		-1, -1},
	{"centerview",  "",      ID_CENTERVIEW,	ANIM_IDLE,		K_END,			-1,		-1, -1},
	{"+zoom",       "",        ID_ZOOMVIEW,	ANIM_IDLE,	-1,	-1,	-1, -1},
	{"weapon 1",    "",         ID_WEAPON1,	ANIM_WEAPON1,	'1',	-1,	-1, -1},
	{"weapon 2",    "",       ID_WEAPON2,	ANIM_WEAPON2,	'2',	-1,	-1, -1},
	{"weapon 3",    "",          ID_WEAPON3,	ANIM_WEAPON3,	'3',	-1,	-1, -1},
	{"weapon 4",    "", ID_WEAPON4,	ANIM_WEAPON4,	'4',	-1,	-1, -1},
	{"weapon 5",    "",  ID_WEAPON5,	ANIM_WEAPON5,	'5',	-1,	-1, -1},
	{"weapon 6",    "",        ID_WEAPON6,	ANIM_WEAPON6,	'6',	-1,	-1, -1},
	{"weapon 7",    "",          ID_WEAPON7,	ANIM_WEAPON7,	'7',	-1,	-1, -1},
	{"weapon 8",    "",       ID_WEAPON8,	ANIM_WEAPON8,	'8',	-1,	-1, -1},
	{"weapon 9",    "",              ID_WEAPON9,	ANIM_WEAPON9,	'9',	-1,	-1, -1},
	{"weapon 10",   "",          ID_WEAPON10,	ANIM_WEAPON10,	-1,	-1,	-1, -1},
	{"weapon 11",   "",          ID_WEAPON11,	ANIM_WEAPON11,	-1,	-1,	-1, -1},
	{"weapon 12",   "",    ID_WEAPON12,	ANIM_WEAPON12,	-1,	-1,	-1, -1},
	{"weapon 13",   "",         ID_WEAPON13,	ANIM_WEAPON13,	-1,	-1,	-1, -1},
	{"+attack",     "",           ID_ATTACK,	ANIM_ATTACK,	K_CTRL,			-1,		-1, -1},
	{"weapprev",    "",      ID_WEAPPREV,	ANIM_IDLE,		'[',			-1,		-1, -1},
	{"weapnext",    "",      ID_WEAPNEXT,	ANIM_IDLE,		']',			-1,		-1, -1},
	{"+button3",    "",          ID_GESTURE,		ANIM_GESTURE,	K_MOUSE3,		-1,		-1, -1},
	{"messagemode", "",             ID_CHAT,		ANIM_CHAT,	-1,			-1,		-1, -1},
	{"messagemode2","",      ID_CHAT2,		ANIM_CHAT,		-1,				-1,		-1, -1},
	{"messagemode3","",    ID_CHAT3,		ANIM_CHAT,		-1,				-1,		-1, -1},
	{"messagemode4","",  ID_CHAT4,		ANIM_CHAT,		-1,				-1,		-1, -1},
	{"+tpvcam",     "",       ID_VOIP_TALK,	ANIM_CHAT,		K_KP_5,				-1,		-1, -1},
	{"+acc",        "",    ID_ACCURACY,	ANIM_ATTACK,		't',			-1,		-1, -1},
	{"weapbest",    "",      ID_WEAPBEST,	ANIM_IDLE,		-1,			-1,		-1, -1},
...
static void Controls_DrawKeyBinding( void *self )
{
	...
	if (c)
	{
		...
		UI_DrawString( x - SMALLCHAR_WIDTH, y, COM_Localize(a->generic.id+214), UI_RIGHT|UI_SMALLFONT, text_color_highlight );
		...
		if (s_controls.waitingforkey)
		{
			...
			UI_DrawString(SCREEN_WIDTH * 0.50, SCREEN_HEIGHT * 0.84, COM_Localize(273), UI_SMALLFONT|UI_CENTER|UI_PULSE, colorWhite );
		}
		else
		{
			UI_DrawChar( x, y, 13, UI_CENTER|UI_BLINK|UI_SMALLFONT, text_color_highlight);
			UI_DrawString(SCREEN_WIDTH * 0.50, SCREEN_HEIGHT * 0.82, COM_Localize(274), UI_SMALLFONT|UI_CENTER, colorWhite );
			UI_DrawString(SCREEN_WIDTH * 0.50, SCREEN_HEIGHT * 0.86, COM_Localize(275), UI_SMALLFONT|UI_CENTER, colorWhite );
		}
	}
	else
	{
		...
		{
			UI_DrawString( x - SMALLCHAR_WIDTH, y, COM_Localize(a->generic.id+214), UI_RIGHT|UI_SMALLFONT, text_color_disabled );
			UI_DrawString( x + SMALLCHAR_WIDTH, y, name, UI_LEFT|UI_SMALLFONT, text_color_disabled );
		}
		else
		{
			UI_DrawString( x - SMALLCHAR_WIDTH, y, COM_Localize(a->generic.id+214), UI_RIGHT|UI_SMALLFONT, text_color_normal );
...
{
	UI_DrawString(SCREEN_WIDTH * 0.50, SCREEN_HEIGHT * 0.84, COM_Localize(276), UI_SMALLFONT|UI_CENTER, colorWhite );
}
...
static void Controls_DrawPlayer( void *self ) {
	...
	if ( !strequals( va("%s:%s", buf, bufhead), s_controls.playerModel ) ) {
		UI_PlayerInfo_SetModel( &s_controls.playerinfo, buf, bufhead );
		strcpy( s_controls.playerModel, va("%s:%s", buf, bufhead) );
...
static void Controls_InitModel( void )
{
	...
	UI_PlayerInfo_SetModel( &s_controls.playerinfo, UI_Cvar_VariableString( "model" ), UI_Cvar_VariableString( "headmodel" ) );
...
static void Controls_Menu_AddPText (menutext_s* menutext, int* y, int id, char* text ) {
	...
	menutext->style			= UI_LEFT;

	*y += PROP_HEIGHT;
}

static void s_controls_menu_draw( void ) {
	trap_R_DrawStretchPic( 0.0, 0.0, uis.glconfig.vidWidth, uis.glconfig.vidHeight, 0, 0, 1, 1, trap_R_RegisterShaderNoMip("menu/art_blueish/frame1_r_mma5") );
...
static void Controls_MenuInit( void )
{
	...
	s_controls.menu.fullscreen = qtrue;
        s_controls.menu.draw = s_controls_menu_draw;
	...
	s_controls.banner.string		= COM_Localize(128);
	s_controls.banner.color			= color_white;
	s_controls.banner.style			= UI_CENTER;

	y = 240 - 2 * PROP_HEIGHT;
	
	Controls_Menu_AddPText(&s_controls.looking,&y,ID_LOOKING, COM_Localize(260));
	Controls_Menu_AddPText(&s_controls.movement,&y,ID_MOVEMENT, COM_Localize(261));
	Controls_Menu_AddPText(&s_controls.weapons,&y,ID_WEAPONS, COM_Localize(262));
	Controls_Menu_AddPText(&s_controls.misc,&y,ID_MISC, COM_Localize(263));
	...
	s_controls.freelook.generic.name		= COM_Localize(264);
	...
	s_controls.invertmouse.generic.name	     = COM_Localize(265);
	...
	s_controls.smoothmouse.generic.name	     = COM_Localize(266);
	...
	s_controls.alwaysrun.generic.name	   = COM_Localize(267);
	...
	s_controls.autoswitch.generic.name      = COM_Localize(268);
	...
	s_controls.autoswitch.itemnames         = autoswitch_items;
        s_controls.autoswitch.itemnames[0] = COM_Localize(255);
        s_controls.autoswitch.itemnames[1] = COM_Localize(256);
        s_controls.autoswitch.itemnames[2] = COM_Localize(257);
        s_controls.autoswitch.itemnames[3] = COM_Localize(258);
        s_controls.autoswitch.itemnames[4] = COM_Localize(259);
	...
	s_controls.sensitivity.generic.name	     = COM_Localize(269);
	...
	s_controls.voip_teamonly.generic.name	    = COM_Localize(270);
	...
	s_controls.joyenable.generic.name	   = COM_Localize(271);
	...
	s_controls.joythreshold.generic.name	  = COM_Localize(272);
