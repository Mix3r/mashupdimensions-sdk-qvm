...
static const char *rate_items[] = {"","","","","",NULL};
...
static void UI_NetworkOptionsMenu_Init( void ) {
	...
	networkOptionsInfo.banner.string			= COM_Localize(129);
	...
	networkOptionsInfo.graphics.string				= COM_Localize(138);
	...
	networkOptionsInfo.display.string				= COM_Localize(139);
	...
	networkOptionsInfo.sound.string					= COM_Localize(140);
	...
	networkOptionsInfo.network.string				= COM_Localize(141);
	...
	networkOptionsInfo.rate.generic.name		= COM_Localize(81);
	...
	networkOptionsInfo.rate.itemnames			= rate_items;
        ...
        networkOptionsInfo.rate.itemnames[0] = "<= 28.8K";
	networkOptionsInfo.rate.itemnames[1] = "33.6K";
	networkOptionsInfo.rate.itemnames[2] = "56K";
	networkOptionsInfo.rate.itemnames[3] = "ISDN";
	networkOptionsInfo.rate.itemnames[4] = COM_Localize(151);

	y += BIGCHAR_HEIGHT+2;
	networkOptionsInfo.allowdownload.generic.type     = MTYPE_RADIOBUTTON;
	networkOptionsInfo.allowdownload.generic.name	   = COM_Localize(83);
	...
	networkOptionsInfo.lagometer.generic.name	   = COM_Localize(152);
	...
	networkOptionsInfo.delaghitscan.generic.name	   = COM_Localize(82);
