...
extern vmCvar_t ui_BobModel; // Mix3r_Durachok: to save gun bob shape
...
extern sfxHandle_t      UI_CacheLocalizedSound(char *snd);
...
extern void UI_DrawBlackHole( int *px, int *py );
