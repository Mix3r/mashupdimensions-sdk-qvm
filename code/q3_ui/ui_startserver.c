...
static void StartServer_MenuInit( void ) {
	...
	s_startserver.banner.string        = COM_Localize(29);
	...
	s_startserver.autonextmap.generic.name		= COM_Localize(30);
	...
	s_startserver.autonextmap.generic.y		= 368;
        ...
        gametype_items[0] = COM_Localize(32);
        gametype_items[1] = COM_Localize(33);
        gametype_items[2] = COM_Localize(34);
        gametype_items[3] = COM_Localize(35);
        gametype_items[4] = COM_Localize(36);
        gametype_items[5] = COM_Localize(37);
        gametype_items[6] = COM_Localize(38);
        gametype_items[7] = COM_Localize(39);
        gametype_items[8] = COM_Localize(40);
        gametype_items[9] = COM_Localize(41);
        gametype_items[10] = COM_Localize(42);
        gametype_items[11] = COM_Localize(43);
        gametype_items[12] = COM_Localize(44);

	s_startserver.gametype.generic.type		= MTYPE_SPINCONTROL;
	s_startserver.gametype.generic.name		= COM_Localize(31);
...
static const char *playerTeam_list2[] = {
	"Blue",
	"Red",
	NULL
};
...
//	trap_Cvar_SetValue( "dedicated", Com_Clamp( 0, 2, dedicated ) );
	...
	for( n = 1; n < PLAYER_SLOTS; n++ ) {
		...
		if(UI_IsATeamGametype(s_serveroptions.gametype)) {
			Com_sprintf( buf, sizeof(buf), "addbot %s %i %s\n", s_serveroptions.playerNameBuffers[n], skill,
				playerTeam_list2[s_serveroptions.playerTeam[n].curvalue] );
		}
		else {
	...
	// set player's team
	if( UI_IsATeamGametype(s_serveroptions.gametype)) {
		trap_Cvar_Set( "g_localTeamPref", playerTeam_list2[s_serveroptions.playerTeam[0].curvalue] );
	}
}
...
static void ServerOptions_SetPlayerItems( void ) {
	...
	// names
	s_serveroptions.player0.string = COM_Localize(55);
...
static void ServerOptions_StatusBar( void* ptr ) {
	UI_DrawString( 320, 440, COM_Localize(56), UI_CENTER|UI_SMALLFONT, colorWhite );
}
...
static void ServerOptions_StatusBar_Allrockets( void* ptr ) {
	UI_DrawString( 320, 440, COM_Localize(58), UI_CENTER|UI_SMALLFONT, colorWhite );
}
...
static void ServerOptions_StatusBar_Pure( void* ptr ) {
	UI_DrawString( 320, 440, COM_Localize(59), UI_CENTER|UI_SMALLFONT, colorWhite );
}
...
static void ServerOptions_StatusBar_Oneway( void* ptr ) {
	UI_DrawString( 320, 440, COM_Localize(60), UI_CENTER|UI_SMALLFONT, colorWhite );
}
...
static void ServerOptions_StatusBar_Pmove( void* ptr ) {
    switch( ((menulist_s*)ptr)->curvalue ) {
		case 0:
			UI_DrawString( 320, 440, COM_Localize(63), UI_CENTER|UI_SMALLFONT, colorWhite );
			UI_DrawString( 320, 460, COM_Localize(62), UI_CENTER|UI_SMALLFONT, colorWhite );
			break;
		case 1:
		case 2:
			UI_DrawString( 320, 440, COM_Localize(64), UI_CENTER|UI_SMALLFONT, colorWhite );
			UI_DrawString( 320, 460, COM_Localize(61), UI_CENTER|UI_SMALLFONT, colorWhite );
			break;
		case 3:
			UI_DrawString( 320, 440, COM_Localize(65), UI_CENTER|UI_SMALLFONT, colorWhite );
			UI_DrawString( 320, 460, COM_Localize(61), UI_CENTER|UI_SMALLFONT, colorWhite );
			break;
		default:
			UI_DrawString( 320, 440, COM_Localize(66), UI_CENTER|UI_SMALLFONT, colorWhite );
			break;
    }
...
static void ServerOptions_InitBotNames( void ) {
	...
	//this SHOULD work
	if(UI_IsATeamGametype(s_serveroptions.gametype)) {
		Q_strncpyz( s_serveroptions.playerNameBuffers[1], "Style", 16 );
		...
		Q_strncpyz( s_serveroptions.playerNameBuffers[4], "KoMnoT", 16 );
		...
		Q_strncpyz( s_serveroptions.playerNameBuffers[6], "Alien3", 16 );
		Q_strncpyz( s_serveroptions.playerNameBuffers[7], "Tanisha", 16 );
		Q_strncpyz( s_serveroptions.playerNameBuffers[8], "Fetaksa", 16 );
		...
		Q_strncpyz( s_serveroptions.playerNameBuffers[10], "Tanisha", 16 );
		if (mapinfo.minTeamSize < 5) {
	...
	for( n = count; n < PLAYER_SLOTS; n++ ) {
		switch(n%4){
			case 0:
				Q_strncpyz( s_serveroptions.playerNameBuffers[n], "Major", sizeof(s_serveroptions.playerNameBuffers[n]));
				break;
			case 1:
				Q_strncpyz( s_serveroptions.playerNameBuffers[n], "Style", sizeof(s_serveroptions.playerNameBuffers[n]) );
				break;
			case 2:
				Q_strncpyz( s_serveroptions.playerNameBuffers[n], "Sarge", sizeof(s_serveroptions.playerNameBuffers[n]) );
				break;
			default:
				Q_strncpyz( s_serveroptions.playerNameBuffers[n], "Tanisha", sizeof(s_serveroptions.playerNameBuffers[n]) );
		}
	}
...
static void ServerOptions_MenuInit( qboolean multiplayer ) {
	...
	s_serveroptions.banner.string  				= COM_Localize(29);
	...
	if(!UI_IsATeamGametype(s_serveroptions.gametype)) {
		...
		s_serveroptions.fraglimit.generic.name       = COM_Localize(20);
		...
		s_serveroptions.flaglimit.generic.name       = COM_Localize(45);
	...
	s_serveroptions.timelimit.generic.name       = COM_Localize(21);
	...
	if(UI_IsATeamGametype(s_serveroptions.gametype) &&
		...
		s_serveroptions.friendlyfire.generic.name     = COM_Localize(46);
	}
	...
	s_serveroptions.pure.generic.name			= COM_Localize(47);
	...
	s_serveroptions.instantgib.generic.name			= COM_Localize(48);
	...
	s_serveroptions.rockets.generic.name			= COM_Localize(49);
	...
	if( s_serveroptions.gametype == GT_LMS ) {
		...
		s_serveroptions.lmsMode.generic.name			= COM_Localize(50);
        ...
        pmove_list[0] = COM_Localize(71);
        pmove_list[1] = COM_Localize(72);
        pmove_list[2] = COM_Localize(73);
        pmove_list[3] = COM_Localize(74);

	y += BIGCHAR_HEIGHT+2;
	s_serveroptions.pmove.generic.type			= MTYPE_SPINCONTROL;
	s_serveroptions.pmove.generic.flags			= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_serveroptions.pmove.generic.name			= COM_Localize(51);
	...
	if( s_serveroptions.multiplayer ) {
		...
		s_serveroptions.lan.generic.name			= COM_Localize(52);
		
		y += BIGCHAR_HEIGHT+2;
		s_serveroptions.hostname.generic.type       = MTYPE_FIELD;
		s_serveroptions.hostname.generic.name       = COM_Localize(53);
        ...
        botSkill_list[0] = COM_Localize(24);
        botSkill_list[1] = COM_Localize(25);
        botSkill_list[2] = COM_Localize(26);
        botSkill_list[3] = COM_Localize(27);
        botSkill_list[4] = COM_Localize(28);
	...
	s_serveroptions.botSkill.generic.name			= COM_Localize(54);
	...
	s_serveroptions.player0.style					= UI_LEFT|UI_SMALLFONT;
        ...
        playerType_list[0] = COM_Localize(70);
        playerType_list[1] = COM_Localize(69);
        playerType_list[2] = "----";
	...
	for( n = 0; n < PLAYER_SLOTS; n++ ) {
		...
		s_serveroptions.playerName[n].generic.right		= s_serveroptions.playerName[n].generic.x + 16 * SMALLCHAR_WIDTH;
                ...
                playerTeam_list[0] = COM_Localize(67);
                playerTeam_list[1] = COM_Localize(68);
